...
tf.app.flags.DEFINE_integer('train_image_source_size', 268, 'Train image size')
tf.app.flags.DEFINE_integer('train_image_target_size', 256, 'Train image size')
tf.app.flags.DEFINE_integer('ground_truth_size', 256, 'Ground truth size (will be different for unet)')
